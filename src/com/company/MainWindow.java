...
public class MainWindow extends JFrame {
    ...
    public JLabel current_election_label = new JLabel("Current election: ");
...
//        add(p);
        ...
        candidates_label.setBounds(10, 44, 100,17);
        new_candidate_label.setBounds(10, 61, 90,17);
        new_candidate_textField.setBounds(100, 61, 190,17);
        candidates_select_list.setBounds(80, 44, 210, 17);
        new_election_button.setBounds(300, 27, size_new_election_button.width, 17);
        new_candidate_button.setBounds(300, 61, size_new_candidate_button.width, 17);
        election_results_button.setBounds(10, 90, size_election_results_button.width, 17);
        vote_button.setBounds(300, 44, size_vote_button.width,17);
        exit_button.setBounds(420 - size_exit_button.width, 90, size_exit_button.width, 17);
        ...
        this.setBounds(500, 300, 450 + insets.left + insets.right, 150 + insets.top + insets.bottom);
